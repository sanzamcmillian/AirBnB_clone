...
class HBNBCommand(cmd.Cmd):
    ...
    def emptyline(self):
        """Do nothing upon receiving an emtyline."""
        pass
    ...
    def do_quit(self, arg):
        """"Quiit command to exit the program."""
        return True
    ...
    def do_update(self, arg):
        """Usage: update <class> <id> <attribute_name> <attribute_value> or <class>.update(<id>, <dictionary>)
